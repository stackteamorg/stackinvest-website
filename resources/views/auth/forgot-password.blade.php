			...
			<div class="user-data-page clearfix d-lg-flex">
				...
				<div class="form-wrapper">
					<form action={{ route('password.email') }} class="user-data-form mt-80 md-mt-40" method="POST">
                        @csrf
						<h5 class="mb-30">رمز عبور خود را فراموش کرده اید؟ مشکلی نیست فقط آدرس ایمیل خود را به ما اطلاع دهید و ما یک پیوند بازنشانی رمز عبور را برای شما ایمیل می کنیم که به شما امکان می دهد رمز جدیدی را انتخاب کنید.</h5>

                        <br/>
						<div class="row">
							<div class="col-12">
								<div class="input-group-meta input-group mb-50">									<label>Email</label>
									<input type="email" name="email">
								</div>
							</div>
							<div class="col-12">
								<button class="theme-btn-one mt-10 mb-50 text-center" type="submit">پیوند بازنشانی رمز عبور ایمیل</button>
							</div>
						</div>
					</form>
				</div> <!-- /.form-wrapper -->
