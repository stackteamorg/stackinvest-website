						   		...
						   		<div class="d-lg-flex justify-content-between align-items-center">
						   			<ul class="navbar-nav">
						   				<li class="nav-item dropdown position-static">
								            <a class="nav-link dropdown-toggle" href="contact-us(cs).html#" data-toggle="dropdown">Home</a>
								        ...
								        <li class="nav-item dropdown">
								            <a class="nav-link dropdown-toggle" href="contact-us(cs).html#" data-toggle="dropdown">Portfolio</a>
								        ...
								        <li class="nav-item dropdown mega-dropdown-md active">
								        	<a class="nav-link dropdown-toggle" href="contact-us(cs).html#" data-toggle="dropdown">Pages</a>
							                <ul class="dropdown-menu">
								                <li>
								                	<div class="row">
								                		<div class="col-lg-3">
								        ...
								        <li class="nav-item dropdown">
								            <a class="nav-link dropdown-toggle" href="contact-us(cs).html#" data-toggle="dropdown">Blogs</a>
								            <ul class="dropdown-menu">
								            	<li class="dropdown-submenu dropdown">
									            	<a href="contact-us(cs).html#" class="dropdown-item dropdown-toggle" data-toggle="dropdown">Third Level Menu</a>
									            	<ul class="dropdown-menu">
									            		<li><a href="contact-us(cs).html#" class="dropdown-item">Menu Level 01</a></li>
										                <li><a href="contact-us(cs).html#" class="dropdown-item">Menu Level 02</a></li>
										                <li><a href="contact-us(cs).html#" class="dropdown-item">Menu Level 03</a></li>
									                </ul>
									            </li>
									            <li>
								        ...
								        <li class="nav-item dropdown">
								            <a class="nav-link dropdown-toggle" href="contact-us(cs).html#" data-toggle="dropdown">Docs</a>
								            <ul class="dropdown-menu">
								            	<li>
									...
									<ul class="right-widget">
										<li class="d-sm-flex">
											<ul class="language-button-group d-flex align-items-center justify-content-center">
										   		<li>
													<a href="contact-us(cs).html#" class="eng-lang active">En. </a>
												</li>
												<li>
													<a href="contact-us(cs).html#" class="ru-lang">Ru.</a>
												</li>
											</ul>
							...
							<div class="col-lg-4 col-sm-6 d-lg-flex">
								<div class="address-info">
									...
									<ul class="d-flex justify-content-center">
										<li><a href="contact-us(cs).html#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
										<li><a href="contact-us(cs).html#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
										<li><a href="contact-us(cs).html#"><i class="fa fa-pinterest" aria-hidden="true"></i></a></li>
									</ul>
								</div> <!-- /.address-info -->
							</div>
						</div>
					...
					<div class="container">
						<div class="row justify-content-between">
							...
							<div class="col-lg-2 col-md-3 col-sm-6 footer-list" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="50">
								...
								<ul>
									<li><a href="contact-us(cs).html#">Take the tour</a></li>
									<li><a href="contact-us(cs).html#">Live chat</a></li>
									<li><a href="contact-us(cs).html#">Self-service</a></li>
									<li><a href="contact-us(cs).html#">Social</a></li>
									<li><a href="contact-us(cs).html#">Mobile</a></li>
									<li><a href="contact-us(cs).html#">Collaboration</a></li>
									<li><a href="contact-us(cs).html#">deski Reviews</a></li>
								</ul>
							</div> <!-- /.footer-list -->
							<div class="col-lg-2 col-md-3 col-sm-6 footer-list" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="100">
								<h5 class="footer-title">Services</h5>
								<ul>
									<li><a href="contact-us(cs).html#">Web Design</a></li>
									<li><a href="contact-us(cs).html#">Development</a></li>
									<li><a href="contact-us(cs).html#">Wordpress</a></li>
									<li><a href="contact-us(cs).html#">Online Marketing</a></li>
									<li><a href="contact-us(cs).html#">Content</a></li>
								</ul>
							</div> <!-- /.footer-list -->
							<div class="col-lg-2 col-md-3 col-sm-6 footer-list" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="150">
								<h5 class="footer-title">About us</h5>
								<ul>
									<li><a href="contact-us(cs).html#">About us</a></li>
									<li><a href="contact-us(cs).html#">Work Portfolio</a></li>
									<li><a href="contact-us(cs).html#">Team</a></li>
									<li><a href="contact-us(cs).html#">Plan & Pricing</a></li>
									<li><a href="contact-us(cs).html#">News</a></li>
								</ul>
							</div> <!-- /.footer-list -->
							<div class="col-lg-3 col-md-3 col-sm-6 address-list" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
								<h5 class="footer-title">Address</h5>
								<ul class="info">
									<li><a href="contact-us(cs).html#">companyinfo@mail.com</a></li>
									<li><a href="contact-us(cs).html#" class="mobile-num">+761 412 3224</a></li>
								</ul>
								<ul class="social-icon d-flex">
									<li><a href="contact-us(cs).html#"><i class="fa fa-facebook"></i></a></li>
									<li><a href="contact-us(cs).html#"><i class="fa fa-twitter"></i></a></li>
									<li><a href="contact-us(cs).html#"><i class="fa fa-linkedin"></i></a></li>
								</ul>
							</div> <!-- /.footer-list -->
						</div> <!-- /.row -->
					</div> <!-- /.container -->
