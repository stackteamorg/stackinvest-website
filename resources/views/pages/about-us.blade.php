		...
		<div class="main-page-wrapper">
						   		...
						   		<div class="d-lg-flex justify-content-between align-items-center">
						   			<ul class="navbar-nav">
						   				<li class="nav-item dropdown position-static">
								            <a class="nav-link dropdown-toggle" href="about-us(cs).html#" data-toggle="dropdown">Home</a>
								        ...
								        <li class="nav-item dropdown">
								            <a class="nav-link dropdown-toggle" href="about-us(cs).html#" data-toggle="dropdown">Blogs</a>
								            <ul class="dropdown-menu">
								            	<li class="dropdown-submenu dropdown">
									            	<a href="about-us(cs).html#" class="dropdown-item dropdown-toggle" data-toggle="dropdown">Third Level Menu</a>
									            	<ul class="dropdown-menu">
									            		<li><a href="about-us(cs).html#" class="dropdown-item">Menu Level 01</a></li>
										                <li><a href="about-us(cs).html#" class="dropdown-item">Menu Level 02</a></li>
										                <li><a href="about-us(cs).html#" class="dropdown-item">Menu Level 03</a></li>
									                </ul>
									            </li>
									            <li>
									...
									<ul class="right-widget">
										<li class="d-sm-flex">
											<ul class="language-button-group d-flex align-items-center justify-content-center">
										   		<li>
													<a href="about-us(cs).html#" class="eng-lang active">En. </a>
												</li>
												<li>
													<a href="about-us(cs).html#" class="ru-lang">Ru.</a>
												</li>
											</ul>
											...
											<ul class="user-login-button d-flex align-items-center justify-content-center">
												...
												<li>
													<a href="sign-up.html" class="signUp-action">Sign Up</a>
												</li>
											</ul>
										</li>
									</ul>
						...
						<div class="row justify-content-center">
							<div class="col-lg-4 col-6" data-aos="fade-up" data-aos-duration="1200">
								<div class="counter-box-three">
									<div class="icon"><img src="images/icon/31.svg" alt=""></div>
							...
							<div class="col-lg-4 col-6" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="100">
								<div class="counter-box-three">
									<div class="icon"><img src="images/icon/32.svg" alt=""></div>
							...
							<div class="col-lg-4 col-6" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
								<div class="counter-box-three">
									<div class="icon"><img src="images/icon/33.svg" alt=""></div>
			...
			<div class="fancy-text-block-ten mt-120 md-mt-60">
				<div class="container">
					<div class="row align-items-end">
						<div class="col-xl-5 col-lg-6 mr-auto order-lg-last" data-aos="fade-right" data-aos-duration="1200">
							<img src="images/icon/34.svg" alt="" class="icon">
						...
						<div class="col-lg-6 order-lg-first">
							<div class="row align-items-end">
								<div class="col-6" data-aos="fade-left" data-aos-duration="1200" data-aos-delay="100"><img src="images/media/img_25.png" alt="" class="img-meta"></div>
								<div class="col-6" data-aos="fade-left" data-aos-duration="1200"><img src="images/media/img_26.png" alt="" class="img-meta"></div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-lg-10 mr-auto">
							<div class="img-gallery mt-60 md-mt-20">
								<div class="row">
									<div class="col-sm-5 sm-mb-20" data-aos="fade-up" data-aos-duration="1200"><img src="images/media/img_27.png" alt="" class="img-meta"></div>
									<div class="col-sm-7" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="100"><img src="images/media/img_28.png" alt="" class="img-meta"></div>
								</div>
							</div> <!-- /.img-gallery -->
						</div>
					</div>
			...
			<div class="fancy-feature-five mt-200 md-mt-100">
				<div class="bg-wrapper">
					...
					<div class="shapes shape-three"></div>
					<div class="shapes shape-four"></div>
					<img src="images/shape/47.svg" alt="" class="shapes shape-five">
					<div class="container">
						...
						<div class="row justify-content-center">
							<div class="col-lg-4 col-sm-6" data-aos="fade-up" data-aos-duration="1200">
								<div class="block-style-seven">
									<div class="icon d-flex align-items-end"><img src="images/icon/35.svg" alt=""></div>
									<div class="feature-info">Customer Value</div>
							...
							<div class="col-lg-4 col-sm-6" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="100">
								<div class="block-style-seven">
									<div class="icon d-flex align-items-end"><img src="images/icon/36.svg" alt=""></div>
									<div class="feature-info">Trusted & Reliable</div>
							...
							<div class="col-lg-4 col-sm-6" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
								<div class="block-style-seven">
									<div class="icon d-flex align-items-end"><img src="images/icon/37.svg" alt=""></div>
									<div class="feature-info">Fast Response</div>
					...
					<div class="container">
						<div class="row justify-content-between">
							<div class="col-lg-2 col-12 footer-about-widget" data-aos="fade-up" data-aos-duration="1200">
								<a href="index-customer-support.html" class="logo"><img src="images/logo/deski_03.svg" alt=""></a>
							</div> <!-- /.about-widget -->
							<div class="col-lg-2 col-md-3 col-sm-6 footer-list" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="50">
								<h5 class="footer-title">Products</h5>
								<ul>
									<li><a href="about-us(cs).html#">Take the tour</a></li>
									<li><a href="about-us(cs).html#">Live chat</a></li>
									<li><a href="about-us(cs).html#">Self-service</a></li>
									<li><a href="about-us(cs).html#">Social</a></li>
									<li><a href="about-us(cs).html#">Mobile</a></li>
									<li><a href="about-us(cs).html#">Collaboration</a></li>
									<li><a href="about-us(cs).html#">deski Reviews</a></li>
								</ul>
							</div> <!-- /.footer-list -->
							<div class="col-lg-2 col-md-3 col-sm-6 footer-list" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="100">
								<h5 class="footer-title">Services</h5>
								<ul>
									<li><a href="about-us(cs).html#">Web Design</a></li>
									<li><a href="about-us(cs).html#">Development</a></li>
									<li><a href="about-us(cs).html#">Wordpress</a></li>
									<li><a href="about-us(cs).html#">Online Marketing</a></li>
									<li><a href="about-us(cs).html#">Content</a></li>
								</ul>
							</div> <!-- /.footer-list -->
							<div class="col-lg-2 col-md-3 col-sm-6 footer-list" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="150">
								<h5 class="footer-title">About us</h5>
								<ul>
									<li><a href="about-us(cs).html#">About us</a></li>
									<li><a href="about-us(cs).html#">Work Portfolio</a></li>
									<li><a href="about-us(cs).html#">Team</a></li>
									<li><a href="about-us(cs).html#">Plan & Pricing</a></li>
									<li><a href="about-us(cs).html#">News</a></li>
								</ul>
							</div> <!-- /.footer-list -->
							<div class="col-lg-3 col-md-3 col-sm-6 address-list" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
								<h5 class="footer-title">Address</h5>
								<ul class="info">
									<li><a href="about-us(cs).html#">companyinfo@mail.com</a></li>
									<li><a href="about-us(cs).html#" class="mobile-num">+761 412 3224</a></li>
								</ul>
								<ul class="social-icon d-flex">
									<li><a href="about-us(cs).html#"><i class="fa fa-facebook"></i></a></li>
									<li><a href="about-us(cs).html#"><i class="fa fa-twitter"></i></a></li>
									<li><a href="about-us(cs).html#"><i class="fa fa-linkedin"></i></a></li>
								</ul>
							</div> <!-- /.footer-list -->
						</div> <!-- /.row -->
					</div> <!-- /.container -->
